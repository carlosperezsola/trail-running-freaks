<div class="dashboard_sidebar">
    ...
    <ul class="dashboard_link">
        ...
        <li><a href="dashboard_download.html"><i class="far fa-cloud-download-alt"></i> Downloads</a></li>
        <li><a href="dashboard_review.html"><i class="far fa-star"></i> Reviews</a></li>
