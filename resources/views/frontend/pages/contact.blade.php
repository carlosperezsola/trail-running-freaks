...
@section('container')
    ...
    <section id="trf__contact">
        <div class="container">
            <div class="trf__contact_area">
                <div class="row">
                    <div class="col-xl-4">
                        <div class="row">
                    ...
                    <div class="col-xl-12">
                        <div class="trf__con_map">
                            <iframe src="{{ $settings->map }}" width="1600" height="450" style="border:0;" allowfullscreen="100" loading="lazy"></iframe>
                        </div>
                    </div>
                </div>
            </div>
