        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="wsus__pro_page_bammer vendor_det_banner">
                    <img src="{{asset('frontend/images/thirdParty_details_banner.jpg')}}" alt="banner" class="img-fluid w-100">
                    <div class="wsus__pro_page_bammer_text wsus__vendor_det_banner_text">
                        <div class="wsus__vendor_text_center">
                            <h4>{{$thirdParty->shop_name}}</h4>
                            <a href="callto:{{$thirdParty->phone}}"><i class="far fa-phone-alt"></i> {{$thirdParty->phone}}</a>
                            <a href="mailto:{{$thirdParty->email}}"><i class="far fa-envelope"></i> {{$thirdParty->email}}</a>
                            <p class="wsus__vendor_location"><i class="fal fa-map-marker-alt"></i> {{$thirdParty->address}}</p>
                            <ul class="d-flex">
