        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xl-9 col-xxl-10 col-lg-9 ms-auto">
                    <a href="{{ route('third_party_user.products-variant-item.index', ['productId' => $product->id, 'variantId' => $variant->id]) }}"
                    ...
                    <div class="dashboard_content mt-2 mt-md-0">
                        ...
                        <div class="wsus__dashboard_profile">
                            <div class="wsus__dash_pro_area">
                                <form action="{{ route('third_party_user.products-variant-item.store') }}" method="POST">
                                    @csrf
