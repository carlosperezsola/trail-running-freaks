...
class ProductVariantItemController extends Controller
{
    ...
    public function create(string $productId, string $variantId)
    {
        $variant = ProductVariant::findOrFail($variantId);
        $product = Product::findOrFail($productId);
        return view('admin_user.product.product-variant-item.create', compact('variant', 'product'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin_user.products-variant-item.index',
    ...
    public function edit(string $variantItemId)
    {
        ...
        return view('admin_user.product.product-variant-item.edit', compact('variantItem'));
    }
