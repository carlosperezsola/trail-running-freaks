...
class ShippingRuleController extends Controller
{
    ...
    {
        return $dataTable->render('admin_user.shipping-rule.index');
    }
    ...
    {
        return view('admin_user.shipping-rule.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin_user.shipping-rule.index');
    ...
    public function edit(string $id)
    {
        ...
        return view('admin_user.shipping-rule.edit', compact('shipping'));
    }
