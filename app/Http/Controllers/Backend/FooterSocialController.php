...
class FooterSocialController extends Controller
{
    ...
    {
        return $dataTable->render('admin_user.footer.footer-socials.index');
    }
    ...
    {
        return view('admin_user.footer.footer-socials.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin_user.footer-socials.index');
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('admin_user.footer.footer-socials.edit', compact('footer'));
    }
